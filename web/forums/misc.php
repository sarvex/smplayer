			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset txtarea">
						...
						<textarea style="BORDER-COLOR: #999 #F0F0F0 #F0F0F0 #999; BORDER-STYLE: solid; BORDER-WIDTH: 1px;" name="req_message" rows="10" cols="75" tabindex="2"></textarea><br /></label>
		...
		<form id="report" method="post" action="misc.php?report=<?php echo $post_id ?>" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">
			<div class="inform">
				<fieldset>
					...
					<div class="infldset txtarea">
						<input type="hidden" name="form_sent" value="1" />
						<label><strong><?php echo $lang_misc['Reason'] ?></strong><br /><textarea style="BORDER-COLOR: #999 #F0F0F0 #F0F0F0 #999; BORDER-STYLE: solid; BORDER-WIDTH: 1px;" name="req_reason" rows="5" cols="60"></textarea><br /></label>
					</div>
				</fieldset>
			</div>
