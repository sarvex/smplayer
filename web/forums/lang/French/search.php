...
'Search in info'			=>	'Choisissez dans quel forum vous souhaitez lancer votre recherche et si vous souhaitez rechercher dans les sujets des discussions ou les textes des messages ou bien les deux à la fois.',
'Forum search'				=>	'Forum',
'All forums'				=>	'Tous les forums',
'Search in'					=>	'Rechercher dans',
'Message and subject'		=>	'Texte du message et du sujet',
'Message only'				=>	'Texte du message seulement',
'Topic only'				=>	'Texte du sujet seulement',
'Sort by'					=>	'Trier par',
'Sort order'				=>	'Ordre',
'Search results legend'		=>	'Selectionnez le mode d\'affichage des résultats',
'Search results info'		=>	'Vous pouvez choisir comment vous voulez classer et afficher les résultats.',
...
'No recent posts'			=>	'Il n\'y a pas de discussion avec de nouveaux messages depuis les dernières 24 heures.',
