					...
					<fieldset>
						...
						<div class="infldset">
							...
							<div class="txtarea">
								...
								<textarea style="BORDER-COLOR: #999 #F0F0F0 #F0F0F0 #999; BORDER-STYLE: solid; BORDER-WIDTH: 1px;" name="signature" rows="4" cols="65"><?php echo pun_htmlspecialchars($user['signature']) ?></textarea><br /></label>
							</div>
							<ul class="bblinks">
