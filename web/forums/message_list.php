...
require PUN_ROOT.'header.php';
?>
	<div class="linkst" style="margin-left: 14em">
		<div class="inbox">
...
<div class="block2col">
	<div class="blockmenu" style="padding: 0px 10px 0px 0px; margin-top: 0px;">
...
?>
<form method="post" action="message_list.php">
<div class="blocktable" style="margin-left: 14em;">
...
<div class="postlinksb" style="margin-left: 14em">
	<div class="inbox">
		<p class="pagelink conl"><?php echo $lang_common['Pages'].': '.paginate($num_pages, $p, 'message_list.php?box='.$box) ?></p>
<?php
