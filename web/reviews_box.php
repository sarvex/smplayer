...
<div id="myCarousel" class="carousel slide">
	...
	*/
	...
	add_quote("SMPlayer is the universal media player solution for Windows and Linux. ".
				...
				"defines the very notion of cross-platform software. ".
	...
	add_quote("Best Player ever used. Hi, Recently i have started using SMPlayer ".
				...
				"Developers... Excellent Product for Free of Cost.", "",
	...
	add_quote("It's really worth to download and start using SMPlayer. ".
				...
				"about missing codecs... I saw in a great quality of image and sound ".
				...
				"immediately synchronized with the movie/video. AMAZING!!! ".
	...
	add_quote("SMPlayer is the one that just plays everything on my PC, ".
				"including the oldest legacy formats and the newest codecs. ".
				"It's easy to use, has a nice GUI, it just works, and has many ".
				"options and settings to configure, though not too many. ;) ".
				"I prefer it to VLC, which is of course very good too, ".
				"but which has many expert settings that I don't understand, ".
				"and which is buggy in version 2.0.0. Keep up the excellent work!", "",
				"malungu", "sf");

	add_quote("In my opinion by miles the best Videoplayer available to those using linux. ".
				"By using MPlayer as the backend you don't have to mess around with additional codecs ".
				"and what not and you can enjoy full hardware acceleration if you have a NVIDIA videocard. ".
				"SMPlayer makes all the powerful options MPlayer offers actually usuable and ".
				"is one of few programs that allows you to do something useful with the mouse thumb buttons. ".
				"The preferred audio/subtitles function made me use it under windows as well ".
				"instead of WMC, as its lack for it greatly annoyed me. ".
	...
	add_quote("This is THE best player for linux. Do not waste your time with VLC, ".
				...
				"and is reliable for anything you will ever need to play.<br>".
				"It NEVER crashes. It NEVER says 'can't play this blah blah blah'. ".
