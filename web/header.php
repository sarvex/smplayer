...
<?php
	...
	print_language_link($file, "Русский", "ru", $query, true);
?>
	</ul>
	</div>
	</div>
...
<?php
	...
	header_print_section(get_tr("Forum"), $rel_path."http://smplayer.berlios.de/forums/index.php?tr_lang=".$tr_lang, ($s=="forums"));
