...
protected slots:
	...
	void displayUpdatingFontCacheStart();
        void displayUpdatingFontCacheEnd();
        void displayFontScanning(QString line);
...
signals:
	...
	void showMessage(QString text);
        void showPermanentMessage(QString text);
	...
	void logLineAvailable(QString);
        void fontCachingStarted();
        void fontCachingFinished();
