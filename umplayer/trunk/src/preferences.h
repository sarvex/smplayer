...
public:
	...
	QString screenshot_directory;
        ...
        // UMPlayer will remember all media settings for all videos.
	...
	int cache_for_files;
	int cache_for_streams_seekable;
        int cache_for_streams_non_seekable;
	int cache_for_dvds;
	int cache_for_vcds;
	...
	//! Windows only. If true, umplayer will pass short filenames to mplayer.
	...
	//! If true, umplayer will use the prefix pausing_keep_force to keep
