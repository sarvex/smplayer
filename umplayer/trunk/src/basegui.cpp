...
void BaseGui::createActions() {
	...
	connect( openFileAct, SIGNAL(triggered()),
        ...
        openFileAct->change( Images::icon("file"), tr("&File...") );
	...
	connect( showFindSubtitlesDialogAct, SIGNAL(triggered()),
        ...
        showFindSubtitlesDialogAct->change( Images::icon("download_subs"), tr("&File...") );
...
#endif
        //UMPlayer Additions
        youtubeAct = new MyAction(QKeySequence("Ctrl+Y"), this, "youtube");
        IconSetter::instance()->youtubeAct = youtubeAct;
        connect(youtubeAct, SIGNAL(triggered()), this, SLOT(showYoutube()));                

        shoutcastAct = new MyAction(QKeySequence("Ctrl+C"), this, "shoutcast");
