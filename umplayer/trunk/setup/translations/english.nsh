...
;English language strings for the Windows UMPlayer NSIS installer.
;
...
${LangFileString} UMPlayer_Is_Running "An instance of UMPlayer is running. Please exit UMPlayer and try again."

${LangFileString} OS_Not_Supported "Unsupported operating system.$\nUMPlayer ${UMPLAYER_VERSION} requires at least Windows XP and may not work correctly on your system.$\nDo you really want to continue with the installation?"
${LangFileString} Win64_Required "A 64-bit Windows operating system is required to install this software."
${LangFileString} Existing_32bitInst "An existing 32-bit installation of UMPlayer exists. You must uninstall 32-bit UMPlayer first."
${LangFileString} Existing_64bitInst "An existing 64-bit installation of UMPlayer exists. You must uninstall 64-bit UMPlayer first."

; Components Page
${LangFileString} ShortcutGroupTitle "Shortcuts"
${LangFileString} MPlayerGroupTitle "MPlayer Components"

${LangFileString} Section_UMPlayer "UMPlayer (required)"
${LangFileString} Section_UMPlayer_Desc "UMPlayer, shared libraries, and documentation."

${LangFileString} Section_DesktopShortcut "Desktop"
${LangFileString} Section_DesktopShortcut_Desc "Creates a shortcut to UMPlayer on the desktop."

${LangFileString} Section_StartMenu "Start Menu"
${LangFileString} Section_StartMenu_Desc "Create a Start Menu entry for UMPlayer."
...
${LangFileString} Section_IconThemes_Desc "Additional icon themes for UMPlayer."

${LangFileString} Section_Translations "Languages"
${LangFileString} Section_Translations_Desc "Non-English language files for UMPlayer."
...
${LangFileString} Reinstall_Msg1 "You have an existing installation of UMPlayer in the following folder:"
...
${LangFileString} Uninstaller_NotInstalled "It does not appear that UMPlayer is installed in the directory '$INSTDIR'.$\r$\nContinue anyway (not recommended)?"
${LangFileString} Uninstaller_64bitOnly "This installation can only be uninstalled on 64-bit Windows."

; Vista & Later Default Programs Registration
${LangFileString} Application_Description "UMPlayer is a complete front-end for MPlayer, from basic features like playing videos, DVDs, VCDs to more advanced features like support for MPlayer filters, edl lists, and more."
