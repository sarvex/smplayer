...
;Tested/Developed with Unicode NSIS 3.0

!define VER_MAJOR "0"
!define VER_MINOR "8"
!define VER_BUILD "5"
!define VER_REVISION "1234"
...
!ifdef WIN64
  OutFile "output\smplayer-${SMPLAYER_VERSION}-x64-nsis3.exe"
!else
  OutFile "output\smplayer-${SMPLAYER_VERSION}-win32-nsis3.exe"
!endif
...
;Custom translations for setup
  ...
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\english.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\basque.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\catalan.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\croatian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\czech.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\danish.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\dutch.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\finnish.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\french.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\german.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\hebrew.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\hungarian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\italian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\japanese.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\korean.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\norwegian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\polish.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\portuguese.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\russian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\simpchinese.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\slovak.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\slovenian.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\spanish.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\thai.nsh"
  !insertmacro LANGFILE_INCLUDE "translations-nsis3\tradchinese.nsh"
