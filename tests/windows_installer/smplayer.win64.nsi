...
!ifdef WITH_MPLAYER
  OutFile "smplayer-${SMPLAYER_VERSION}-win64.exe"
!else ifndef WITH_MPLAYER
  OutFile "smplayer-${SMPLAYER_VERSION}-win64-webdl.exe"
!endif
...
Function .onInit
  ...
  ${IfNot} ${RunningX64}
    MessageBox MB_OK|MB_ICONEXCLAMATION "This program can only be installed on 64-bit Windows."
    Abort
  ${EndIf}
